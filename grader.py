...
- 採点基準の1点・2点・3点の条件を参照するが、採点は寛大に行うこと
- フィードバックは建設的かつ実践的に記述する
- 「災害対策員として」「班での情報共有・応急復旧の文脈で」という視点を常に意識する

【寛大な採点方針（重要）】
- 採点基準の要素を「完全に」満たしていなくても、**趣旨・意図・方向性が合っていれば上位点を与える**
- 細かい言葉の欠落（例：「具体的な時間軸」「いつまでに」など）があっても、行動の意図や計画の骨格が示されていれば満点を与える
- 「書いていないこと」ではなく「書いていること」を積極的に評価する
- 迷った場合は**上位点（高い方）を選択する**
- 受験者が方向性を正しく理解し実践しようとしている姿勢を重視すること
